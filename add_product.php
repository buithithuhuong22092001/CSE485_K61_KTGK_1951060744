...
if(isset($_POST['sbm'])){
    ...
    if(!isset($error)){
        $sql = "INSERT INTO product (prd_name, prd_price, prd_image, prd_status, prd_featured, prd_details) VALUES ('$prd_name', $prd_price, '$prd_warranty', '$prd_accessories', '$prd_promotion', '$prd_new', '$prd_image', $cat_id, $prd_status, $prd_featured, '$prd_details')";
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="prd_status" class="form-control">
                                    <option value=1 selected>Đã mượn</option>
